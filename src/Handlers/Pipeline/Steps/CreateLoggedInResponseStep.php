...
class CreateLoggedInResponseStep implements OAuthCallbackPipelineStep
{
    use CreatesConnectedAccountResponses;

    public function __invoke(OAuthCallbackPipelineContext $context)
    {
        return $this->createLoggedInResponse($context->getClient(), $context->getSocialUser(), $context->getUser());
    }
}
